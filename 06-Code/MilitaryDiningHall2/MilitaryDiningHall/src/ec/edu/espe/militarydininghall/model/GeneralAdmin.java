...
public class GeneralAdmin {
    ...
    public GeneralAdmin(int id, String name, String email, String password, String grade, String type, float balance, List<String> daysReserved) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public String toString() {
        return "GeneralAdmin{" + "id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", grade=" + grade + ", type=" + type + ", balance=" + balance + ", daysReserved=" + daysReserved + '}';
    }
